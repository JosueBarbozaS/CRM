...
namespace IngeTechCRM.Models
{
    public class IngeTechDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Configuración de nombres de tablas y triggers
            ...
            // Configurar tabla de comunicados con trigger
            modelBuilder.Entity<Comunicado>().ToTable("CRM_COMUNICADO", tb => tb.HasTrigger("TR_COMUNICADO_PROGRAMAR"));
